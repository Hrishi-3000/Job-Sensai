...
const HeroSection = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Create professional resumes tailored to each job application."
    },
    {
      icon: (
        <svg className="w-6 h-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.6 }} className="flex flex-col sm:flex-row justify-center gap-4 mb-14">
            ...
            <motion.a href="#" className="w-full md:w-auto inline-flex items-center justify-center py-3 px-7 text-base font-semibold text-center text-indigo-600 rounded-full bg-white border border-indigo-600 hover:bg-indigo-50 transition-all duration-300" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              How It Works
            </motion.a>
          </motion.div>
